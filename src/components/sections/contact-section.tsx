              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-5 bg-white rounded-3xl p-6 md:p-10 shadow-xl border border-(--color-primary)/10 relative overflow-hidden h-full">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 mt-4">
                  <div className="space-y-1.5">
                    <label htmlFor="name" className="block text-sm font-semibold text-[rgb(100,98,92)]">{t('contact.form.name')}</label>
                    <input
                      id="name"
                      type="text"
                      name="name"
                  ...
                  <div className="space-y-1.5">
                    <label htmlFor="phone" className="block text-sm font-semibold text-[rgb(100,98,92)]">{t('contact.form.phone')}</label>
                    <input
                      id="phone"
                      type="tel"
                      name="phone"
                ...
                <div className="space-y-1.5">
                  <label htmlFor="email" className="block text-sm font-semibold text-[rgb(100,98,92)]">{t('contact.form.email')}</label>
                  <input
                    id="email"
                    type="email"
                    name="email"
                ...
                <div className="space-y-1.5">
                  <label htmlFor="service" className="block text-sm font-semibold text-[rgb(100,98,92)]">{t('contact.form.service')}</label>
                  <select
                    id="service"
                    name="service"
                ...
                <div className="space-y-1.5">
                  <label htmlFor="message" className="block text-sm font-semibold text-[rgb(100,98,92)]">{t('contact.form.message')}</label>
                  <textarea
                    id="message"
                    name="message"
              ...
              <div className="bg-(--color-bg-dark) text-white rounded-3xl p-6 md:p-8 shadow-xl relative overflow-hidden flex-1">
                ...
                <div className="space-y-5 relative z-10">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-400">{t('contact.info.location_title')}</p>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-400">{t('contact.info.contact_title')}</p>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-400">{t('contact.info.email_title')}</p>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-400">{t('contact.info.hours_title')}</p>
      ...
      <div className="max-w-5xl mx-auto px-4 md:px-8 relative z-10">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-10">
          ...
          <div className="bg-white rounded-2xl p-5 shadow-lg border border-(--color-primary)/10 text-center hover:shadow-xl transition-shadow">
            ...
            <p className="text-[rgb(100,98,92)] text-sm">{CONTACT_INFO.LOCATION}</p>
          </div>
          ...
          <div className="bg-white rounded-2xl p-5 shadow-lg border border-(--color-primary)/10 text-center hover:shadow-xl transition-shadow">
            ...
            <p className="text-[rgb(100,98,92)] text-sm">{CONTACT_INFO.HOURS}</p>
          </div>
        </div>
