...
export const HeroSectionNew: React.FC = () => {
  ...
  const checkmarks = [
    t('home.hero.checkmarks.custom'),
    t('home.hero.checkmarks.premium'),
    t('home.hero.checkmarks.install'),
  ];

  return (
    <section className="relative w-full min-h-[80vh] md:min-h-screen pt-12 pb-16 md:pt-20 md:pb-28 overflow-hidden">
      {/* Background Image */}
      <div className="absolute inset-0">
        <img
          src={BUSINESS_INFO.HERO_IMAGE}
          alt="Elite Custom Cabinets"
          className="w-full h-full object-cover"
        />
        {/* Gradient Overlay for text readability */}
        <div className="absolute inset-0 bg-linear-to-r from-slate-900/90 via-slate-900/70 to-slate-900/40" />
        <div className="absolute inset-0 bg-linear-to-t from-slate-900/60 via-transparent to-slate-900/30" />
      </div>

      <div className="max-w-4xl mx-auto px-4 md:px-8 relative z-10 pt-20 md:pt-32">
        <div className="text-center">
          ...
          {/* Subtitle */}
          <p className="text-lg md:text-xl text-gray-200 mb-8 leading-relaxed max-w-2xl mx-auto drop-shadow-md">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-10">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-6 py-4 rounded-xl border-2 border-white/30 text-white font-semibold hover:border-[#25D366] hover:text-[#25D366] hover:bg-white/10 transition-all duration-200"
            >
