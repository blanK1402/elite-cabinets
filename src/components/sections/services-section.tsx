            ...
            return (
              ...
              >
                ...
                <div className="w-full md:w-5/12">
                  <div className="relative overflow-hidden rounded-4xl shadow-2xl group border border-(--color-primary)/5 hover:border-(--color-primary)/20 transition-colors duration-500">
                    <img
                      src={service.image}
                      alt={t(`services.${service.key}.title`)}
                      className="w-full h-auto block transition-transform duration-700 group-hover:scale-110"
                    />
                    <div className="absolute inset-0 bg-linear-to-t from-(--color-bg-dark)/40 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                  </div>
                </div>
