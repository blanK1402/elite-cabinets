          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <Link to="/" className="flex items-center gap-3 mb-6 transition-transform hover:scale-[1.02] duration-300">
              ...
              <div>
                ...
                <span className="block text-xs text-(--color-primary) font-bold uppercase tracking-[0.2em]">
                  {t('header.tagline')}
                </span>
              </div>
            </Link>
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className="w-9 h-9 sm:w-10 sm:h-10 rounded-lg bg-white/10 hover:bg-(--color-primary)/30 flex items-center justify-center transition-colors text-white hover:text-white"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 sm:w-10 sm:h-10 rounded-lg bg-white/10 hover:bg-[#25D366]/30 flex items-center justify-center transition-colors text-white hover:text-white"
                aria-label="WhatsApp"
              >
                <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="currentColor" viewBox="0 0 24 24">
